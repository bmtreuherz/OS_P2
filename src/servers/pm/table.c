...
int (*call_vec[])(void) = {
	...
	no_sys,		/* 54 = ioctl	*/
	no_sys,		/* 55 = fcntl	*/
	do_plog,		/* 56 = getplogsize	*/
	no_sys,		/* 57 = unused	*/
	do_plog,		/* 58 = getplogbyindex	*/
	do_exec,	/* 59 = execve	*/
	no_sys,		/* 60 = umask	*/
	no_sys,		/* 61 = chroot	*/
	do_set,		/* 62 = setsid	*/
	...
	do_plog,		/* 69 = resetplog	*/
	do_plog,		/* 70 = getplogbypid	*/
	...
	do_plog,		/* 108 = plogstatestart */
	do_plog,		/* 109 = plogstatestop */
	no_sys,		/* 110 = unused */
